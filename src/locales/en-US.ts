export const starter = {
  ...
  "studio.chipLabel": "Annotation tools",
  "studio.chipOpenCount": "Annotation tools ({{count}} open)",
  "studio.dragToolbar": "Drag toolbar",
  "studio.expandToolbar": "Expand toolbar",
  "studio.collapseToolbar": "Collapse toolbar",
  ...
  "studio.copyAnnotations": "Copy annotations",
  ...
  "studio.visibilityShow": "Show markers",
  "studio.visibilityHide": "Hide markers",
  "studio.helpTitle": "Keyboard shortcuts",
  "studio.helpSafety":
    "Shortcuts are ignored while typing in inputs, textareas or other editable fields.",
  "studio.helpEsc": "Esc — cancel the current capture or popover",
  "studio.listAction": "Annotation list",
  "studio.listTitle": "Annotations",
  "studio.listSelect": "Annotation {{number}}: select",
  "studio.listCounts": "{{open}} open · {{total}} total",
  ...
  "studio.emptyOpenList": "No open annotations.",
  "studio.emptyAllList": "No annotations yet.",
} as const;
