...
**性能基线：** fresh Chromium 1920×1080 screenshot 355 ms、40,387 bytes；69-point Area 146 ms；dynamic DOM 10 秒 marker refresh 12 次；200-candidate prune 的 focused unit 基线记录在外部 focused log（算法上限 200 candidates、最终 50）。
...
**下一可靠起点：** package Goal 07 commit `29597d142ebf9c3575e473f212fa1191af98a974` 与随后 Portal plan-only commit；必须先独立复核 committed trees。Goal 08 仍未开始。
