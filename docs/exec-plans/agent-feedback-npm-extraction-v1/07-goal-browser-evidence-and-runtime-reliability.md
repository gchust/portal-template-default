...
**性能基线：** 最终 fresh Chromium 1920×1080 screenshot 344 ms、40,777 bytes；69-point Area 最坏 142 ms；dynamic DOM 10 秒 marker refresh 12 次；200-candidate prune focused unit 81.948 ms（算法上限 200 candidates、最终 50）。
