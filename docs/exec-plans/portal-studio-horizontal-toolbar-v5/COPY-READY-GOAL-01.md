# COPY-READY — Portal Studio Horizontal Toolbar v5 Goal 01

Use this document as the current Code Agent task. It combines the authoritative shared contract sections relevant to Goal 01 with the implementation Goal.
